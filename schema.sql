...
-- Stripe mock / Creem 测试占位价格映射（真实接入时替换 external_id）
INSERT OR IGNORE INTO plan_prices (id, project_id, plan_id, platform, external_id, interval, currency, amount_cents) VALUES
...
('creem_pro_monthly',       'clearcut', 'pro',      'creem',  'creem_test_pro_monthly',      'month', 'USD', 999),
('creem_pro_yearly',        'clearcut', 'pro',      'creem',  'creem_test_pro_yearly',       'year',  'USD', 9990),
('creem_business_monthly',  'clearcut', 'business', 'creem',  'creem_test_business_monthly', 'month', 'USD', 2999),
('creem_business_yearly',   'clearcut', 'business', 'creem',  'creem_test_business_yearly',  'year',  'USD', 29990);
...
('creem_50_credits',   'clearcut', '50',  '50 Credits',  50,  'creem',  'creem_test_50_credits',  'USD', 499,  NULL,   10),
('creem_200_credits',  'clearcut', '200', '200 Credits', 200, 'creem',  'creem_test_200_credits', 'USD', 1499, 'best', 20),
('creem_500_credits',  'clearcut', '500', '500 Credits', 500, 'creem',  'creem_test_500_credits', 'USD', 2999, NULL,   30);
